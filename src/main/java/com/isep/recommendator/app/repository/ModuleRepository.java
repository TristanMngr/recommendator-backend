...
public interface ModuleRepository extends JpaRepository<Module, Long> {
    ...
    @Query("SELECT new com.isep.recommendator.app.custom_object.SpecialityAndConcept(spe, c) FROM Module m join m.specialityModules s join m.concepts c join s.speciality spe WHERE c.concept_id in (:concept_ids) ORDER BY spe.speciality_id")
